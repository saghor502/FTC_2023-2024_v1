...
public class OdometryGlobalCoordinatePosition implements Runnable{
    ...
    private double initialRbotGlobalXCoordinatePosition = 0;
    private double initialRbotGlobalYCoordinatePosition = 0;
...
//        prevNormalEncoderWheelPosition = normalEncoderWheelPosition;
        ...
        initialRbotGlobalXCoordinatePosition = p*Math.sin(changeInRobotOrientation) + n*Math.cos(changeInRobotOrientation);
        initialRbotGlobalYCoordinatePosition = p*Math.cos(changeInRobotOrientation) - n*Math.sin(changeInRobotOrientation);
    ...
    private void globalCoordinatePositionUpdate(){
        ...
        //Calculate Angle
        //aquì se cambiò y funcionò la coordenada en vuelta
        changeInRobotOrientation = (- leftChange + rightChange) / (robotEncoderWheelDistance);
        ...
        robotGlobalXCoordinatePosition = (robotGlobalXCoordinatePosition +
                (p*Math.sin(robotOrientationRadians) + n*Math.cos(robotOrientationRadians))) + initialRbotGlobalXCoordinatePosition;
        robotGlobalYCoordinatePosition = (robotGlobalYCoordinatePosition +
                (p*Math.cos(robotOrientationRadians) - n*Math.sin(robotOrientationRadians))) + initialRbotGlobalYCoordinatePosition;
