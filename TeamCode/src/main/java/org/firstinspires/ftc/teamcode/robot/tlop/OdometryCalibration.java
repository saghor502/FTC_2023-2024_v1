 ...
 */
@TeleOp(name = "Odometry System Calibration", group = "2 Calibration")
public class OdometryCalibration extends LinearOpMode {
    ...
    final double COUNTS_PER_INCH = 238.99371049052830188679245283018;
    ...
    public void runOpMode() throws InterruptedException {
       ...
       */
        ...
        //al cambiar el signo se arreglan coordenadas, falla orientaciòn
        double verticalEncoderTickOffsetPerDegree =  encoderDifference /angle;
        // 2*Math.abs(verticalLeft.getCurrentPosition()) +
     ...
     * @param rof power for right front motor
     * @param rob power for right back motor
     * @param lof power for left front motor
     * @param lob power for left back motor
     */
    private void setPowerAll(double rof, double rob, double lof, double lob){
        right_front.setPower(rof);
        right_back.setPower(rob);
        left_front.setPower(lof);
        left_back.setPower(lob);
    }
